...
$query = "SELECT bid.bid_id, bid.proj_id, project_details.project_name,bid.bid_amount,bid.submit_time
FROM bid
INNER JOIN project_details
ON bid.proj_id=project_details.project_id where bid.employee_email='$abcd'";
